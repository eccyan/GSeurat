...
void GsDemoApp::init_game_content() {
    init_window();
...
void GsDemoApp::init_scene(const std::string& scene_path) {
...
void GsDemoApp::clear_scene() {
    // GS demo has no ECS entities to clear
}

void GsDemoApp::generate_particle_atlas() {
...
void GsDemoApp::generate_shadow_texture() {
...
void GsDemoApp::generate_flat_normal_texture() {
    std::filesystem::create_directories("assets/textures");
