    ...
    const bricklayerFile: BricklayerFile = {
      ...
      scene: {
        ...
        player: {
          ...
          speed: engine.player?.speed ?? 20,
          acceleration: engine.player?.acceleration ?? 20,
          jump_height: engine.player?.jump_height ?? 4,
          jump_duration: engine.player?.jump_duration ?? 0.8,
        },
        backgroundLayers: [],
